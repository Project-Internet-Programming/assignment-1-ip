...
public class ShoppingServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
                ...
                Vector<VCDBean> buylist = (Vector)session.getAttribute("cart");
                ...
                if (action.equals("ADD"))
                {
                    ...
                    try {
                        ...
                        if (index >= 0 && index < buylist.size()) {
                            VCDBean vcd = buylist.elementAt(index);
                            ...
                            out.println("<html>\n" +
                                    ...
                                    "<center><a href=\"ShoppingServlet?action=VIEW\">View Cart</a>&nbsp;&nbsp;<a href=\"index.html\">Continue Shopping</a>&nbsp;&nbsp;<a href=\"ShoppingServlet?action=CHECKOUT\">Checkout</a>\n" +
                                    "&nbsp;&nbsp;<a href=\"ShoppingServlet?action=LOGOUT\">Logout/Remove</a>\n" +
                                    "</center></body>\n" +
                                    "</html>\n");
                        }else {
                            out.println("<html>\n" +
                                    ...
                                    "</head>\n" +
                                    "<body bgcolor=\"#33CCFF\">\n" +
                                    "<center><B>Error: Invalid item index</B></center><br>\n" +
                                    "<center><a href=\"ShoppingServlet?action=VIEW\">View Cart</a>&nbsp;&nbsp;<a href=\"index.html\">Continue Shopping</a>&nbsp;&nbsp;<a href=\"ShoppingServlet?action=CHECKOUT\">Checkout</a>\n" +
                                    "&nbsp;&nbsp;<a href=\"ShoppingServlet?action=LOGOUT\">Logout/Remove</a>\n" +
                                    "</center></body>\n" +
                                    "</html>\n");
